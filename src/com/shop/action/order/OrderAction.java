...
public class OrderAction extends BaseAction implements ModelDriven<Order>{
    ...
    public String findByCustomer() throws Exception {
        if(getLoginCustomer() != null){//如果用户已登录
            ...
            PageModel pageModel = orderDao.find(where, queryParams, orderby , pageNo, pageSize);//执行查询方法
        }
    ...
    public String list() throws Exception {
        ...
        PageModel pageModel = orderDao.find(where, params.toArray(), orderby, pageNo, pageSize);//执行查询方法
